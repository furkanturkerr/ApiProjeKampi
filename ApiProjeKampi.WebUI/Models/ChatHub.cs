...
using ApiProjeKampi.WebUI.Controllers;
...
public class ChatHub : Hub
{
    ...
    public async Task StreamOpenAI(List<Dictionary<string, string>> history, CancellationToken cancellationToken)
    {
        ...
        history.Add(new() { ["role"] = "assistant", ["content"] = fullMessage });
        await Clients.Caller.SendAsync("ComplateMessage", fullMessage, cancellationToken);
    }
